...
models = ['gpt-3.5-turbo','gpt-4','text-davinci-003','text-curie-001'] #put here models available
...
def app_question():
	...
	st.selectbox('Select document to ask questions', file_names, key='file_names')
	disabled = False
